package com.example.application.views.masterdetailbooks;
...
@PageTitle("Master-Detail Books")
@Route(value = "master-detail4/:sampleBookID?/:action?(edit)")
public class MasterDetailBooksView extends Div implements BeforeEnterObserver {

    private final String SAMPLEBOOK_ID = "sampleBookID";
    private final String SAMPLEBOOK_EDIT_ROUTE_TEMPLATE = "master-detail4/%s/edit";
    ...
    public MasterDetailBooksView(@Autowired SampleBookService sampleBookService) {
        this.sampleBookService = sampleBookService;
        addClassNames("master-detail-books-view");
        ...
        grid.asSingleSelect().addValueChangeListener(event -> {
            if (event.getValue() != null) {
                ...
                clearForm();
                UI.getCurrent().navigate(MasterDetailBooksView.class);
            }
        });
        ...
        save.addClickListener(e -> {
            try {
                ...
                SampleBook value = this.sampleBook;
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (sampleBookId.isPresent()) {
            ...
            if (sampleBookFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(MasterDetailBooksView.class);
            }
        }
    }
